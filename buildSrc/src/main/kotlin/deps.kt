object Ver {
    ...
    const val google_auto_service = "1.0-rc6"
}
...
object Libs {
    ...
    const val kotlin_logging = "io.github.microutils:kotlin-logging:${Ver.kotlin_logging}"
    const val google_auto_service = "com.google.auto.service:auto-service:${Ver.google_auto_service}"
    const val kotlin_poet = "com.squareup:kotlinpoet:${Ver.kotlin_poet}"
